...
\includegraphics[width=0.4\textwidth]{{../images/force/Force-vel1.0}.png}
\label{fig:force1}
}
\subfloat[Velocity 0.10m/s]{
\includegraphics[width=0.40\textwidth]{{../images/force/Force-vel10.0}.png}
\label{fig:force10}
}

\subfloat[Velocity 0.20m/s]{
\includegraphics[width=0.40\textwidth]{{../images/force/Force-vel20.0}.png}
\label{fig:force20}
}
\subfloat[Velocity 0.30m/s]{
\includegraphics[width=0.40\textwidth]{{../images/force/Force-vel30.0}.png}
\label{fig:force30}
}

\subfloat[Velocity 1.0m/s]{
\includegraphics[width=0.40\textwidth]{{../images/force/Force-vel100.0}.png}
\label{fig:force50}
}
\subfloat[Velocity 3.0m/s]{
\includegraphics[width=0.40\textwidth]{{../images/force/Force-vel300.0}.png}
\label{fig:force300}
}
...
Now considering a harder material, i.e. with Young's Modulus$(E)$ of $9.3GPa$ and mass density of 900$Kg/m^{3}$. This Young's Modulus was chosen as it was neither to hard nor to soft and had the vibration visible. The plots in figure \ref{fig:force} show the contact force between the sphere and the rigid plane. The plots shows that as the impact velocities are higher, the difference between the simulation data and the theoretical data is more visible. This errors is due the quasi static assumptions.
...
A similar trend is also visible in the plot of the strain energy of the sphere. It is clear from figure \ref{fig:SEzoomed}, that after the collision is complete, the body still possesses a small amount of strain energy.
...
To understand the loss of energy to vibrations, the coefficient of restitution was calculate for an elastic material with $Youngs Modulus(E)$ of $9.3GPa$ and various impact velocities ranging from $0.01m/s$ to $5m/s$.
...
To understand the plot in figure \ref{fig:COR}, the modal analysis of the sphere was necessary. The natural frequencies of the sphere can affect the trajectory of the sphere during the impact. The two natural modes are shown in figure \ref{fig:modes}.
